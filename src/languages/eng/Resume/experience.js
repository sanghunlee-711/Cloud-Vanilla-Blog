export const SOCAR = {
  ...
  raffleBackoffice: {
    ...
    delivery: "In backoffice (marketing), handled eventPage/winnerPage form editing while embedding /event/single-benefit-draw-preview from socar-server-frontend via an <object> tag",
    impact: "Separated data sources by route: production page (/event/single-benefit-draw/:eventId) uses API data, preview uses ?previewdata JSON parsing, enabling quick QA by only updating object data URL"
  },
  couponWebview: {
