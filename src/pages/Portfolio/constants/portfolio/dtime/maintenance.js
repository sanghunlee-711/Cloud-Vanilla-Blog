export const DTIME_MAINTENANCE = {
  ...
  exploreComment: `
    근태관리, 결재 관리, 연락처 조회, 시간외 근무신청, 부서 직원 관리 및 설정 등을 통합 제공하는 웹 서비스입니다.
    UI/UX를 개발하며 상태관리 패턴의 정립 및 UI, 비즈니스 로직 테스트를 도입하여 주니어로 구성된 개발팀에 안정성을 증대하였습니다.
  `,
  devExplains: [
    {
      image:
      ...
      explanation: [
        'testing-library를 활용하여 Flux패턴에서 일관성 있는 테스트 케이스 정립하였습니다.',
        'Cypress로 일부페이지의 E2E테스트를 진행하며 프론트엔드 파트의 퀄리티 상승을 도모하였습니다.',
      ],
    },
    {
      image:
      ...
      explanation: [
        'Generator를 통해 순수함수로 제공되는 전역 비동기 상태관리를 위한 redux-saga와 전역 상태관리인 Redux-toolkit을 활용하였습니다.',
        'Flux패턴으로 상태관리 패턴을 적용하여 추후 로직의 추가 및 제거 또는 테스트에 일관성을 제공하였습니다.',
      ],
    },
  ],
};
