export const THE_FOLKS_PORTFOLIO = {
  ...
  유저들끼리 서로의 게시글을 쉽게 볼 수 있게 해주었고, 해당 페이지를 크루생성자가 커스터마이징 할 수 있도록 기능을 제공합니다.
  `,
  devExplains: [
    {
      image:
      ...
      explanation: [
        '중복 타입 선언을 방지하기 위해 Apollo Client의 Codegen기능을 활용하여 백엔드와 프론트의 타입을 유기적 동기화 진행하였습니다.',
    ...
    },
    {
      ...
      explanation: [
        '검색최적화(SEO)를 위해 필요한 지식들인 robot.txt, manifest.json, 각 검색 주요창에서의 검색엔진으로의 등록, 유기적인 메타태그 제공 등의 지식을 습득하고 적용했습니다.',
      ],
    },
  ],
};
