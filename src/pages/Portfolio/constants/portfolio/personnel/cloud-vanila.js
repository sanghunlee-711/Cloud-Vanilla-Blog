export const CLOUD_VANILLA_PORTFOLIO = {
  ...
  exploreComment: `자체 프레임워크로 만든 블로그는 Vanilla JS를 공부하며 SPA 라이브러리의 CSR 작동방식과 유사하게 구현된 블로그입니다.
    작성자 개인의 글, 포트폴리오, 이력서를 포함하였고 프린트 기능이 제공되며 Markdown파일로 작성된 글들을 렌더링 해주고 있습니다.
  ...
  devExplains: [
    {
      ...
      explanation: [
        'CSR의 Routing시스템을 위해 Web HistoryAPI를 이용하였습니다.',
        '각 컴포넌트는 state기반 렌더링의 일관성을 가지는 class형태로 구성되었습니다.',
        '기본적인 SPA 특징들에 대한 공부와 동시에 시간이 지나도 유지 보수가 용이하게 가장 단순하고 낮은 레벨에서의 구현을 진행했습니다.',
      ],
    },
    {
      image:
      ...
      explanation: [
        '하나의 EC2서버에서 Nginx의 포트포워딩을 통해 백엔드와 프론트를 제공합니다.',
        '규모가 크지 않은 프로젝트이므로 불필요한 낭비를 지양하기 위해 내부 폴더를 DB처럼 활용하여 MD파일들을 불러옵니다.',
      ],
    },
  ],
};
