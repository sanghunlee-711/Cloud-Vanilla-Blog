export const BACK_OFFICE_MONOREPO = {
  ...
  exploreComment: `
    ...
    이 과정을 통해 팀 내 개발자들의 불필요한 다른 도메인간의 싱크로율에 대한 고민이 사라지게 되었습니다.
  `,
  devExplains: [
    {
      image:
      ...
      explanation: `
      백오피스 특성상 유사한 UI에 다른 도메인이 연결되는 페이지 생성이 많았으므로 이의 반복작업을 용이하게 하기 위해
    ...
    },
    {
      ...
      explanation: `
      yarn workspace의 기본설정,타입스크립트의 절대경로 세팅, jest의 moduleNameMapper 등 프로젝트별 소스코드 공유를 위함에 있어 필요한 기본세팅 진행 및 각 커밋마다 전체 프로젝트에 영향을 미칠 수 있으므로 안정성 증대를 위한 husky를 활용한 프리커밋 세팅등을 진행하였습니다.
      `,
    },
  ],
};
