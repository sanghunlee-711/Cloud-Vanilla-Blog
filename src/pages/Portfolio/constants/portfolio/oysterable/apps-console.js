export const APPS_CONSOLE = {
  ...
  exploreComment: `
    ...
    앱 내 제공되는 다양한 이벤트 및 배너, 공지사항 등의 수정 및 작성을 위한 기능이 제공되며 내부 임직원의 업무효율 향상을 도모했습니다.
  `,
  devExplains: [
    {
      image:
      ...
      explanation: `
      React-Query를 사용하여 도메인상태와 UI상태 분리를 진행하여 불 필요한 메모리 낭비를 지양하였습니다.
      `,
    },
    {
      image:
      ...
      explanation: `
      중복 UI 및 로직은 각각 UI라이브러리 및 Hooks로 분리하여 재활용을 진행하며 중복되는 코드의 작성을 감소시켰습니다.
      `,
    },
  ],
};
