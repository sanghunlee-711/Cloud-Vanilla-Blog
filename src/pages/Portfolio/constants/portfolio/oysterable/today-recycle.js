export const TODAY_RECYCLE = {
  ...
  exploreComment: `  
  오늘의 분리수거 앱은 캔, 투명 페트, 종이팩등의 반납기기가 제공되며 분리배출을 실천 시 포인트 제공 및 기업, 지역 등에서 제공해 준 다양한 보상품을 구매할 수 있는 서비스를 제공합니다.
  `,
  devExplains: [
    {
      image:
      ...
      explanation: `
        ...
        50회(라우팅 기준의 유저플로우)에서 6회(로그인,구매, 기부 등의 일부 시점)로 90% 정도 감소, 이로 인해 서버자원의 낭비방지 및 UX 개선을 진행했습니다.
      `,
    },
    {
      image:
      ...
      explanation: `
      비즈니스의 주 고객이 구 버전의 Android기기 사용이 다수 있어 웹뷰 내부의 일부 메서드(Array의 some, every 등)가 지원되지 않아 기능의 누락이 되는 것을 발견, react-app-polyfill의 일부 항목을 적용시켜 이를 해결하였습니다.
      `,
    },
  ],
};
