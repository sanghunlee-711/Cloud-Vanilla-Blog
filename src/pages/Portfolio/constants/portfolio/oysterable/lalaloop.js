export const OA_LALALOOP_PORTFOLIO = {
  ...
  exploreComment: `
    랄라루프 디쉬 프로젝트는 배달앱들과 서울시의 협업을 통해 다회용기로 주문한 경우, 다회용기 회수를 위한 제공방법으로 진행,
    자사가 제공하는 반납기 기기로의 반납을 진행할 수 있도록 지도에 위치를 표기해주는 페이지가 제공되며 반납 완료 후 카카오톡 비즈니스 메시지를 통해 제공되는 링크로 인센티브 입금을 요청할 수 있는 기능을 지원한다.
    현재 140여건 이상의 반납이 진행 (2023.03 GA 기준)
  `,
  devExplains: [
    {
      image:
