export const OA_LALALOOP_PORTFOLIO = {
  ...
  devAchivement: [
    '크로스 브라우징 시 스타일 관리를 위한 기법 학습 (IOS의 Viewport문제 등)',
  ...
  exploreComment: `
    랄라루프 디쉬 프로젝트는 배달앱들과 서울시의 협업을 통해 다회용기로 주문한 경우, 다회용기 회수를 위한 제공방법으로 개발되었습니다.
    자사가 제공하는 반납기 기기로의 반납을 진행할 수 있도록 지도에 위치를 표기해주는 페이지가 제공되며 반납 완료 후 카카오톡 비즈니스 메시지를 통해 제공되는 링크로 인센티브 입금을 요청할 수 있는 기능을 지원합니다.
  ...
  devExplains: [
    {
      ...
      explanation: `
        다양한 디바이스에서 접근하는 비즈니스의 특성 상 크로스 브라우징 문제를 해결하기 위해 IOS의 viewport인식 문제를 JS로 해결 및 input, button 태그의 스타일 일관성을 부여하는 등의 작업 진행
      `,
    },
    {
      image:
      ...
      explanation: `
        Next.js의 프론트 서버기능을 활용하여 프로젝트 내부 폴더에 존재하는 html 약관 파일을 file-system 라이브러리를 통해 불러와 렌더링 해줌으로써 약관과 프로젝트의 독립성 확보.
      `,
    },
  ],
};
